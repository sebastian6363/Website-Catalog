...
<body>
    <section class="content">
        <div class="form-content">
            ...
            $id     = $_GET['id'];
            $query  = mysqli_query($connect, "SELECT * FROM product WHERE idBarang = $id");
            ...
            <form class="form" id="form" enctype="multipart/form-data"> 
                <div class="form-element">
                    ...
                    <input name="idBarang" id="idBarang" value="<?php echo $row['idBarang']; ?>" type="hidden" />
                    <input type="text" name="nama" id="nama" class="form-control" required autocomplete="off" value="<?php echo $row['nama'] ?>">
                </div>
                <div class="form-element">
                    <label for="merk" class="form-label">Merk Product</label>
                    <input type="text" name="merk" id="merk" class="form-control" required autocomplete="off" value="<?php echo $row['merk'] ?>">
                </div>
                <div class="form-element">
                ...
                <div class="form-element">
                    ...
                    <input type="text" name="size" id="size" class="form-control" required autocomplete="off" value="<?php echo $row['size'] ?>">
                </div>
                <div class="form-element">
                ...
                <div class="buttons">
                    <button type="submit" class="btn-submit">Simpan Edit</button>
